...
module Blueprint
  class Compressor
    ...
    attr_accessor :namespace, :css_files, :custom_css, :custom_layout, :semantic_classes, :project_name, :plugins
    ...
    def initialize
      ...
      self.css_files = Blueprint::CSS_FILES
      self.custom_css = {}
    ...
    def initialize_project_from_yaml(project_name = nil)
      ...
      if (project = projects[project_name]) # checks to see if project info is present
        ...
        self.css_files =        project['css_files']        || Blueprint::CSS_FILES
    ...
    def generate_css_files
      self.css_files.each do |output_file_name, css_source_file_names|
